...
router.get('/', protect, authorize('Admin', 'Manager', 'HR', 'Sales'), procurementController.getAllProcurements);
router.get('/:id', protect, authorize('Admin', 'Manager', 'HR', 'Sales'), procurementController.getProcurementById);
