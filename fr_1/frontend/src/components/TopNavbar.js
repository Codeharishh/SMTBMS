...
const GLOBAL_SEARCH_INDEX = [
  ...
  { title: 'Material Movements', path: '/material-movements', category: 'Material Tracking', keywords: 'movements logistics transfers inbound outbound stock', desc: 'Internal movements, transfers & receipts' },
  ...
  { title: 'OCR Scanner', path: '/ocr-scanner', category: 'Material Tracking', keywords: 'ocr scanner image text extract read bills invoices', desc: 'Extract data from physical bills and invoices' },
  { title: 'Employee Directory', path: '/hrms/directory', category: 'HRMS', keywords: 'employees staff directory workforce profiles users', desc: 'Personnel profiles, roles & contact records' },
  ...
  { title: 'Financial Operations', path: '/erp/finance', category: 'ERP Workspace', keywords: 'finance budget accounts ledger revenue payables', desc: 'Budgets, revenue & transaction ledgers' },
  { title: 'Team Monitoring', path: '/manager/team', category: 'ERP Workspace', keywords: 'team monitoring live tracking status efficiency', desc: 'Live team status & member efficiency' },
  { title: 'Task Assignment', path: '/manager/tasks', category: 'ERP Workspace', keywords: 'tasks task tokens assign workflow priorities due date', desc: 'Assign & track task tokens dynamically' },
  { title: 'Project Tracking', path: '/manager/projects', category: 'ERP Workspace', keywords: 'projects milestones site budget progress tracking', desc: 'Monitor project progress, sites & budget' },
  { title: 'Approvals Hub', path: '/manager/approvals', category: 'ERP Workspace', keywords: 'approvals pending requests governance decision', desc: 'Review & action pending approval requests' },
  ...
  { title: 'Sales Opportunities', path: '/sales/opportunities', category: 'CRM', keywords: 'opportunities sales pipeline deals quotes revenue', desc: 'Active sales deals & pipeline stages' },
  { title: 'Sales Quotations', path: '/sales/quotations', category: 'CRM', keywords: 'quotations quotes pricing proposals estimates sales', desc: 'Generate & send commercial quotes' },
  { title: 'Sales Targets', path: '/sales/targets', category: 'CRM', keywords: 'targets quota goals revenue targets sales rep', desc: 'Monthly sales quotas & achievement index' },
  { title: 'Sales Revenue Tracking', path: '/sales/revenue', category: 'CRM', keywords: 'revenue sales tracking income cashflow forecast', desc: 'Realized sales revenue & cashflow trends' },
  ...
  { title: 'Support & Service Desk', path: '/crm/support', category: 'Support', keywords: 'support tickets service desk SLA customer issues', desc: 'Customer ticket resolution & SLA monitoring' },
  { title: 'Help & Support', path: '/admin/support', category: 'Support', keywords: 'help support FAQ knowledge base user manual guide', desc: 'Knowledge base FAQs & system guides' },
  { title: 'User Management', path: '/admin/users', category: 'Admin', keywords: 'users user management credentials roles accounts access', desc: 'Platform credentials & role assignment' },
  { title: 'Roles & Permissions', path: '/admin/roles-permissions', category: 'Admin', keywords: 'roles permissions matrix access control privilege', desc: 'Granular role permissions & matrix' },
  { title: 'System Audit Logs', path: '/admin/audit-logs', category: 'Admin', keywords: 'audit logs security compliance history security events', desc: 'Security audit trail & action logs' },
  ...
  { title: 'Integrations Gateway', path: '/admin/integrations', category: 'Admin', keywords: 'integrations webhook API slack email gateway webhooks', desc: 'Connect external services & webhooks' },
  { title: 'Backup & Restore', path: '/admin/backups', category: 'Admin', keywords: 'backup restore database snapshot data protection backup', desc: 'Database backups & one-click restore' },
